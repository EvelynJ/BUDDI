FUNCTION read_sersic_results_2comp_s, obj, nband, bd=bd,boxy=boxy
...
; NEIGH_GALFIT HAS TO BE ADAPTED!
    ...
    if keyword_set(bd) then begin
        feedback = create_struct('mag_galfit_d', -999., 'magerr_galfit_d',99999., $
                                 ...
                                 're_galfit_cheb_comp3', fltarr(nband)-99., 'reerr_galfit_cheb_comp3', fltarr(nband)+99999., $
                                 'n_galfit_cheb_comp3', fltarr(nband)-99., 'nerr_galfit_cheb_comp3' ,fltarr(nband)+99999., $
                                 'q_galfit_cheb_comp3', fltarr(nband)-99., 'qerr_galfit_cheb_comp3', fltarr(nband)+99999., $
                                 'pa_galfit_cheb_comp3', fltarr(nband), 'paerr_galfit_cheb_comp3', fltarr(nband)+99999., $
