...
;       V2.54: Improved color shuffling for final plot. 
;           MC, Oxford, 30 November 2009
;       V2.55: Added PIXSIZE keyword. MC, Oxford, 28 April 2010
;       V2.56: Use IDL intrinsic function DISTANCE_MEASURE for 
;           automatic pixelSize, when PIXSIZE keyword is not given. 
;           MC, Oxford, 11 November 2011
;       V2.57: Included safety termination criterion of Lloyd algorithm
;           to prevent loops using /WVT. MC, Oxford, 24 March 2012
;       V2.58: Update Voronoi tessellation at the exit of bin2d_cvt_equal_mass.
;           This is only done when using /WVT, as DIFF may not be zero at the 
;           last iteration. MC, La Palma, 15 May 2012
;       V2.6: Included new SN_FUNCTION to illustrate the fact that the user can
...
bin2d_compute_useful_bin_quantities, x, y, signal, noise, xnode, ynode, scale, class, xbar, ybar, sn, area
...
if keyword_set(plot) then begin
    ...
    ;plots, xbar, ybar, PSYM=1, SYMSIZE=0.5
