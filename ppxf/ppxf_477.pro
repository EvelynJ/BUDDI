...
END
;----------------------------------------------------------------------------
PRO ppxf_477, templates, galaxy, noise1, velScale, start, sol, output, run, $
...
if keyword_set(plot) then begin
 ...
 ;       YRANGE=[-2,mx], YSTYLE=2, XRANGE=[-0.02,1.02]*s2[1]*s2[0]
    ...
    close,01
    openu,01,output+'_kinematics.txt',/append
    if run eq 0 then printf,01, '#bin','feval', 'V', 'sigma', 'h3', 'h4', 'h5', 'h6', 'Chi2/DOF', FORMAT='(9A10)'
    printf,01, run,ncalls, sol[0:6], FORMAT='(2i10,2f10.1,5f10.3)'
    close,01
