;3 component, 4th component (PSF) commented out

FUNCTION read_sersic_results3, obj, nband, bd=bd
...
; avoiding crash
    ...
    if not keyword_set(bd) then begin
        feedback = create_struct('mag_galfit', result[0].COMP2_MAG, 'magerr_galfit',result[0].COMP2_MAG_ERR, $
                                 ...
                                 'x_galfit_band_psf', result.COMP3_XC, 'xerr_galfit_band_psf',result.COMP3_XC_ERR, $
                                 'y_galfit_band_psf', result.COMP3_YC, 'yerr_galfit_band_psf',result.COMP3_YC_ERR, $
                                 'mag_galfit_band_psf', result.COMP3_MAG, 'magerr_galfit_band_psf',result.COMP3_MAG_ERR, $
                                 'x_galfit_cheb_psf', res_cheb.COMP3_XC, 'xerr_galfit_cheb_psf',res_cheb.COMP3_XC_ERR, $
                                 'y_galfit_cheb_psf', res_cheb.COMP3_YC, 'yerr_galfit_cheb_psf',res_cheb.COMP3_YC_ERR, $
                                 'mag_galfit_cheb_psf', res_cheb.COMP3_MAG, 'magerr_galfit_cheb_psf',res_cheb.COMP3_MAG_ERR, $
...
;                                 'x_galfit_band_psf', result.COMP4_XC, 'xerr_galfit_band_psf',result.COMP4_XC_ERR, $
;                                 'y_galfit_band_psf', result.COMP4_YC, 'yerr_galfit_band_psf',result.COMP4_YC_ERR, $
;                                 'mag_galfit_band_psf', result.COMP4_MAG, 'magerr_galfit_band_psf',result.COMP4_MAG_ERR, $
...
;                                 'x_galfit_cheb_psf', res_cheb.COMP4_XC, 'xerr_galfit_cheb_psf',res_cheb.COMP4_XC_ERR, $
;                                 'y_galfit_cheb_psf', res_cheb.COMP4_YC, 'yerr_galfit_cheb_psf',res_cheb.COMP4_YC_ERR, $
;                                 'mag_galfit_cheb_psf', res_cheb.COMP4_MAG, 'magerr_galfit_cheb_psf',res_cheb.COMP4_MAG_ERR, $
                                 'sky_galfit_cheb', res_cheb.COMP1_SKY, $
