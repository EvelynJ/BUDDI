...
;    if column eq 33 and row eq 33 then stop
...
if setup.bin_data eq 'y' then begin
  ...
  fits_read,root+directory+file+'.fits',input_IFU,header_IFU
  fits_read,'/Users/ejohnsto/Manga/7443-9102_ss/manga-7443-9102-LOGCUBE.fits',temp_xxxx,header_ifu_xxxx
...
;      datacube[column,row,*]=spec_xy;maggies2cts(IFU_maggies[column,row,*],exptime,zp)
      
      spec_xy=input_IFU[column,row,*]
      datacube[column,row,*]=spec_xy;maggies2cts(IFU_maggies[column,row,*],exptime,zp)
   endfor
  endfor
...
if setup.bin_datacube eq 'y' then begin
    output=root+directory
    bin_datacube_temp,corrected_IFU, no_bins, root,directory,decomp, binned_dir,slices_dir,median_dir,galaxy_ref,file,start_wavelength, end_wavelength,  wavelength, binned_wavelengths,x_centre,y_centre,/galaxy,/PSF,/MANGA
endif
...
if setup.decompose_median_image eq 'y' then begin
  ...
  h = headfits('/Users/ejohnsto/Manga/7443-9102_ss/manga-7443-9102-LOGCUBE.fits');,exten='FLUX')
...
if setup.visualise_results eq 'y' then result_visualiser_test,root,directory,decomp,galaxy_ref,slices_dir,info,x_centre,y_centre,start_wavelength,end_wavelength,wavelength,Redshift,n_comp,setup.comp3_type,setup.comp4_type,setup.comp4_x,setup.comp4_y,no_slices,/MANGA
