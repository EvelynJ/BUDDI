;sersic, psf, psf, psf
FUNCTION read_sersic_results_4psf_p_p, obj, nband, bd=bd
...
ENDIF ELSE BEGIN
    ...
    if not keyword_set(bd) then begin
        feedback = create_struct('mag_galfit', -999., 'magerr_galfit',99999., $
                                 ...
                                 'x_galfit_cheb_b', fltarr(ncheb), 'xerr_galfit_cheb_b', fltarr(ncheb)+99999., $
                                 'y_galfit_cheb_b', fltarr(ncheb), 'yerr_galfit_cheb_b', fltarr(ncheb)+99999., $ 
                                 'mag_galfit_cheb_b', fltarr(ncheb), 'magerr_galfit_cheb_b', fltarr(ncheb)+99999., $ 
    ...
    if keyword_set(bd) then begin
        feedback = create_struct('mag_galfit_d', -999., 'magerr_galfit_d',99999., $
                                ...
                                'x_galfit_band_b', fltarr(nband), 'xerr_galfit_band_b', fltarr(nband)+99999., $
                                 ...
                                 'y_galfit_cheb_b', fltarr(ncheb), 'yerr_galfit_cheb_b', fltarr(ncheb)+99999., $ 
                                 'mag_galfit_cheb_b', fltarr(ncheb), 'magerr_galfit_cheb_b', fltarr(ncheb)+99999., $ 
                                 're_galfit_cheb_b', fltarr(ncheb)-99., 'reerr_galfit_cheb_b', fltarr(ncheb)+99999., $
                                 'n_galfit_cheb_b', fltarr(ncheb)-99., 'nerr_galfit_cheb_b' ,fltarr(ncheb)+99999., $
                                 'q_galfit_cheb_b', fltarr(ncheb)-99., 'qerr_galfit_cheb_b', fltarr(ncheb)+99999., $
                                 'pa_galfit_cheb_b', fltarr(ncheb), 'paerr_galfit_cheb_b', fltarr(ncheb)+99999., $
