FUNCTION read_sersic_results_3sersic, obj, nband, bd=bd
...
; avoiding crash
    ...
    if not keyword_set(bd) then begin
        feedback = create_struct('mag_galfit_d', result[0].COMP2_MAG, 'magerr_galfit_d',result[0].COMP2_MAG_ERR, $
                                 ...
                                 'x_galfit_band_comp4', result.COMP3_XC, 'xerr_galfit_band_comp4',result.COMP3_XC_ERR, $
                                 'y_galfit_band_comp4', result.COMP3_YC, 'yerr_galfit_band_comp4',result.COMP3_YC_ERR, $
                                 'mag_galfit_band_comp4', result.COMP3_MAG, 'magerr_galfit_band_comp4',result.COMP3_MAG_ERR, $
                                 're_galfit_band_comp4', result.COMP3_RE, 'reerr_galfit_band_comp4', result.COMP3_RE_ERR, $
...
;                                 'mag_galfit_band_psf', result.COMP4_MAG, 'magerr_galfit_band_psf',result.COMP3_MAG_ERR, $
                                 ...
                                 're_galfit_band_comp4', result.COMP4_RE, 'reerr_galfit_band_comp4', result.COMP4_RE_ERR, $
